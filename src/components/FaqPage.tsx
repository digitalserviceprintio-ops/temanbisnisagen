...
const faqs = [
  { q: 'Apa itu Dmini ATM?', a: 'Dmini ATM adalah aplikasi pencatatan transaksi untuk agen branchless banking. Digunakan untuk mencatat tarik tunai, setor tunai, transfer, dan top up saldo.' },
