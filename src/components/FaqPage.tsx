...
const faqs = [
  { q: 'Apa itu Buku Agen?', a: 'Buku Agen adalah aplikasi pencatatan transaksi untuk agen branchless banking. Digunakan untuk mencatat tarik tunai, setor tunai, transfer, dan top up saldo.' },
